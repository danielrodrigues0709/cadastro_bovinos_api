...
module.exports.createVacinasTable = async (nome_schema) => {
    const schema = nome_schema ? nome_schema+'.': '';
    await dbQuery(`CREATE TABLE IF NOT EXISTS ${schema}vacinas (id SERIAL PRIMARY KEY, vacina_vermifugo VARCHAR(50), tipo VARCHAR(50), doses SMALLINT)`);
